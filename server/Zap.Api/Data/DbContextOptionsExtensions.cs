...
public static class DbContextOptionsExtensions
{
    ...
    private static void SetTicketTypes(this DbContext ctx)
    {
        ...
        [
            new TicketType(){ Name = TicketTypes.ChangeRequest },
            new TicketType(){ Name = TicketTypes.Defect },
            new TicketType(){ Name = TicketTypes.Enhanecment },
            new TicketType(){ Name = TicketTypes.Feature },
            new TicketType(){ Name = TicketTypes.GeneralTask },
        ...
        [
            new TicketStatus(){ Name = TicketStatuses.InDevelopment },
            new TicketStatus(){ Name = TicketStatuses.New },
            new TicketStatus(){ Name = TicketStatuses.Resolved },
