...
namespace Zap.Api.Data.Migrations
{
    ...
    [Migration("20260410223505_AddSearchIndexesAndTicketDisplayId")]
    partial class AddSearchIndexesAndTicketDisplayId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zap.Api.Data.Models.StoredFile", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Zap.Api.Data.Models.Ticket", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("DisplayId"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("DisplayId"), new[] { "gin_trgm_ops" });
            ...
            modelBuilder.Entity("Zap.Api.Data.Models.TicketAttachment", b =>
                {
                    b.HasOne("Zap.Api.Data.Models.StoredFile", "File")
                        .WithOne("TicketAttachment")
                        .HasForeignKey("Zap.Api.Data.Models.TicketAttachment", "FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
