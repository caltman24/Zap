...
import {FormFieldHeader, formInputClassName, FormSelectControl, formTextareaClassName,} from "~/components/FormShell";
...
export default function ProjectCommonRoute({loaderData, userInfo, collection}: ProjectRouteParams) {
    ...
    if (error || !project) {
        return (
            <RouteLayout>
                <div
                    className="rounded-[1.5rem] bg-[var(--app-surface-container-low)] p-6 text-[var(--app-error)] outline outline-[var(--app-outline-variant-soft)]">
                    {error}
                </div>
            </RouteLayout>
        );
    ...
    return (
        <RouteLayout className="space-y-8">
            ...
            <section className="border-b border-[var(--app-outline-variant)]/10 pb-8">
                {isEditing ? (
                    <div className="space-y-6 p-6 sm:p-8">
                        <div
                            className="flex flex-wrap items-start justify-between gap-4 border-b border-[var(--app-outline-variant)]/10 pb-6">
                            <div>
                        ...
                        <Form className="space-y-8" method="post">
                            {formError ? (
                                <div
                                    className="rounded-2xl bg-[var(--app-error-container)]/20 px-4 py-3 text-sm text-[var(--app-error)] outline-1 outline-[var(--app-error)]/10">
                                    {formError}
                                </div>
                            ) : null}
                            ...
                            <div className="grid gap-6">
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <FormSelectControl name="priority"
                    ...
                    <>
                        ...
                        <div
                            ...
                            <dl className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4 xl:gap-5">
                                <div
                                    className={`border-l-2 border-[var(--app-primary-fixed-strong)] pl-4 ${!project.capabilities.canAssignProjectManager && "flex flex-col gap-4"}`}>
                                    <div className="flex justify-between gap-4">
                                        <dt className="app-shell-mono text-[10px] uppercase tracking-[0.22em] text-[var(--app-outline)]">Project
                                            Manager
                                        </dt>
                                        {project.capabilities.canAssignProjectManager ? (
                                            <div className="flex items-center gap-1">
                                                ...
                                                >
                                                    <span
                                                        className="material-symbols-outlined text-base">person_add</span>
                                                </button>
                                                {project.projectManager ? (
                                                    ...
                                                    >
                                                        <span
                                                            className="material-symbols-outlined text-base">person_remove</span>
                                                    </button>
                                                ) : null}
                                            </div>
                                        ) : null}
                                    ...
                                    {project.projectManager ? (
                                        <dd className="flex items-center gap-3">
                                            ...
                                            />
                                            <span
                                                className="text-sm font-medium text-[var(--app-on-surface)]">{project.projectManager.name}</span>
                                        </dd>
                                    ) : (
                                ...
                                <div className="border-l-2 border-[var(--app-tertiary)] pl-4 flex flex-col gap-5">
                                    <div
                                        className="app-shell-mono text-[10px] uppercase tracking-[0.22em] text-[var(--app-outline)]">Priority
                                    </div>
                                ...
                                <div className="space-y-3 border-l-2 border-[var(--app-secondary)] pl-4">
                                    <dt className="app-shell-mono text-[10px] uppercase tracking-[0.22em] text-[var(--app-outline)]">Due
                                        Date
                                    </dt>
                                    <dd className="flex items-center gap-3">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div
                                                className={`flex items-center gap-2 text-xs ${deadlineMeta.textClass}`}>
                                                <span
                                                    className="material-symbols-outlined text-sm">{deadlineMeta.icon}</span>
                                                {deadlineMeta.label}
                                            </div>
                                        </div>
                                    </dd>
                                ...
                                <div className="border-l-2 border-[var(--app-success)] pl-4 flex flex-col gap-5">
                                    <dt className="app-shell-mono text-[10px] uppercase tracking-[0.22em] text-[var(--app-outline)]">Team
                                        Size
                                    </dt>
            ...
            <section className="space-y-4">
                ...
                <div
                    className="rounded-[1.5rem] bg-[var(--app-surface-container-low)] px-6 py-5 outline-1 outline-[var(--app-outline-variant-soft)]">
                    {project.capabilities.canManageMembers ? (
                        <>
                            <MemberListModal
