...
export default function MemberListModal({
  ...
  return (
    <dialog
      className="m-auto w-full max-w-3xl overflow-visible border-0 bg-transparent p-0 text-left text-[var(--app-on-surface)] shadow-none backdrop:bg-black/70 backdrop:backdrop-blur-sm"
      id="member-modal"
      onClick={(event) => {
    ...
    >
      <div className="w-full rounded-[2rem] bg-[var(--app-surface-container-low)] p-0 outline outline-1 outline-[var(--app-outline-variant-soft)]">
        <div className="border-b border-[var(--app-outline-variant)]/10 px-6 py-5 sm:px-8">
          <div>
            <h3 className="text-xl font-bold tracking-tight text-[var(--app-on-surface)]">Select Members</h3>
