    ...
    return (
        <div className="app-shell">
            <div className="min-h-screen lg:pl-[15.5rem]">
                <div
                    className="hidden outline outline-1 outline-[var(--app-outline-variant-soft)] lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:flex lg:w-[15.5rem]">
                ...
                <div className="flex min-h-screen min-w-0 flex-col">
                    ...
                    <div className="relative min-h-0 flex-1 overflow-y-auto">
                        ...
                        {navigation.state === "loading" ? (
                            <div
                                className="pointer-events-none absolute inset-0 grid place-items-center bg-[var(--app-loading-overlay)] backdrop-blur-[2px]">
                                <div
                                    className="flex items-center gap-3 rounded-full bg-[var(--app-surface-container-panel)] px-4 py-3 text-sm text-[var(--app-on-surface)] outline outline-1 outline-[var(--app-outline-variant-faint)] shadow-[var(--app-panel-shadow)]">
                                    <span className="h-2.5 w-2.5 animate-pulse rounded-full bg-[var(--app-primary)]"/>
                                    <span
                                        className={`${monoClass} text-[11px] uppercase tracking-[0.22em] text-[color:var(--app-on-surface-variant)]`}>
                    Loading
                  </span>
                                </div>
                            </div>
