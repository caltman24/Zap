    ...
    return (
        <RouteLayout className="space-y-6">
            <div className="flex flex-wrap items-end justify-between gap-4">
                ...
                <span
                    className="app-shell-mono text-xs uppercase tracking-[0.22em] text-[var(--app-outline)]">{totalProjects} archived</span>
            </div>
            ...
            {totalProjects > 0 ? (
                ...
                <div
                    ...
                    <p className="text-base text-[var(--app-on-surface-variant)]">No archived projects match your
                        current scope.</p>
                </div>
            )}
        </RouteLayout>
