...
export default function AttachmentList({ attachments, onRemove, onView, onDownload, canRemove }: AttachmentListProps) {
  ...
  return (
    <div className="space-y-3">
      {attachments.map((attachment) => {
        ...
        return (
          <div
            ...
            key={attachment.id}
          >
            <div className={`inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl ${tone}`}>
              <span className="material-symbols-outlined text-2xl">{getFileIcon(attachment.type, attachment.name)}</span>
            </div>
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs text-[var(--app-on-surface-variant)]">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-t border-[var(--app-outline-variant)]/10 pt-4 text-xs text-[var(--app-on-surface-variant)]">
