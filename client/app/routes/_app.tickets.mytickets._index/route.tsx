        ...
        <RouteLayout className="space-y-6">
            <div className="flex flex-wrap items-end justify-between gap-4">
                <div className="space-y-2">
                    <div>
                        <h1 className="text-3xl font-bold tracking-[-0.03em] text-[var(--app-on-surface)]">My
                            Tickets</h1>
                ...
                <div className="px-4 py-2">
                    <span
                        className="app-shell-mono text-xs uppercase tracking-[0.22em] text-[var(--app-outline)]">{totalTickets} assigned tickets</span>
                </div>
            </div>
