    ...
    <RouteLayout className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="space-y-2">
          <div>
            <h1 className="text-3xl font-bold tracking-[-0.03em] text-[var(--app-on-surface)]">All Projects</h1>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <span className="app-shell-mono text-xs uppercase tracking-[0.22em] text-[var(--app-outline)]">{totalProjects} active</span>
      ...
      {totalProjects > 0 ? (
        ...
        <div className="rounded-[1.5rem] bg-[var(--app-surface-container-low)] p-8 text-center outline outline-1 outline-[var(--app-outline-variant-soft)]">
          <p className="text-base text-[var(--app-on-surface-variant)]">No projects match your current scope.</p>
        </div>
      )}
    </RouteLayout>
  );
