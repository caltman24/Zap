...
import {compareTicketStrings, getTicketPriorityDotClass, getTicketStatusChipClass,} from "./ticketTableUtils";
...
export default function DashboardTicketTable({
    ...
    return (
        <section
            className="overflow-hidden rounded-[1.75rem] bg-[var(--app-surface-container-low)] outline outline-1 outline-[var(--app-outline-variant-soft)]">
            <div
                className="flex flex-col gap-4 bg-[color:var(--app-surface-container-high)]/50 p-4 md:flex-row md:items-center md:justify-between">
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start justify-between gap-3">
                                    ...
                                    <span
                                        className={`app-shell-mono inline-flex shrink-0 rounded-md px-2.5 py-1 text-[10px] uppercase tracking-[0.2em] ${getTicketStatusChipClass(ticket.status)}`}>
                    {ticket.status}
                  </span>
                                </div>
                                ...
                                <div className="flex flex-wrap items-center gap-4 text-sm text-[var(--app-on-surface)]">
                                    <div className="flex items-center gap-2">
                                        <span
                                            className={`h-2.5 w-2.5 rounded-full ${getTicketPriorityDotClass(ticket.priority)}`}/>
            ...
            <div className="hidden overflow-x-auto md:block">
                <table className="w-full min-w-[880px] border-collapse text-left">
                    <thead
                        className="border-b border-[color:var(--app-outline-variant)]/10 bg-[var(--app-surface-container-lowest)]">
                    <tr>
                    ...
                    {visibleTickets.length > 0 ? (
                      ...
                      <span className="app-shell-mono text-xs text-[var(--app-outline)]">
                        ...
                        <tr>
                            <td className="px-6 py-12 text-center text-sm text-[var(--app-on-surface-variant)]"
                                colSpan={5}>
                                No recent ticket activity found.
                            </td>
                        </tr>
