            ...
            <tr className="transition-colors hover:bg-[var(--app-hover-overlay)]/50" key={member.id}>
              <td className="px-0 py-4">
                <div className="flex items-center gap-3">
                  <span className="inline-flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-[var(--app-surface-container-high)]">
              ...
              {showRole ? <td className="px-0 py-4 text-sm text-[var(--app-on-surface-variant)]">{member.role}</td> : null}
            </tr>
          ))}
        </tbody>
      </table>
