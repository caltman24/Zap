    ...
    return (
        <div
          ...
          <span className="material-symbols-outlined text-lg">
                ...
                <table className="w-full min-w-[1050px] border-collapse text-left">
                    ...
                    {visibleTickets.length > 0 ? (
                      ...
                      <span className="app-shell-mono text-xs text-[var(--app-outline)]">
                        ...
                        <tr>
                            <td className="px-6 py-14 text-center text-sm text-[var(--app-on-surface-variant)]"
                                colSpan={5}>
                                No tickets found for the current filters.
                            </td>
                        </tr>
            ...
            <div
                className="flex flex-wrap items-center justify-between gap-3 bg-[var(--app-surface-container-lowest)] px-4 py-4">
        <span className="app-shell-mono text-xs text-[var(--app-outline)]">
